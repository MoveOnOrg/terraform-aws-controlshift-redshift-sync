...
## @type: DataSource
## @args: [database = "controlshift_production", table_name = "signatures", transformation_ctx = "datasource0"]
## @return: datasource0
## @inputs: []
datasource0 = glueContext.create_dynamic_frame.from_catalog(database = "controlshift_production", table_name = "signatures", transformation_ctx = "datasource0")
...
## @type: DataSource
## @args: [database = "controlshift_production", table_name = "signatures", push_down_predicate= f"(partition_0 == {latestpartition})", transformation_ctx = "datasource1"]
## @return: datasource1
## @inputs: []
...
datasource1 = glueContext.create_dynamic_frame.from_catalog(
    database = "controlshift_production",
...
## @type: DataSink
## @args: [catalog_connection = "controlshift_production_data_sync", connection_options = {"dbtable": "signatures", "database": "dev"}, redshift_tmp_dir = TempDir, transformation_ctx = "datasink4"]
## @return: datasink4
## @inputs: [frame = resolvechoice2]
datasink4 = glueContext.write_dynamic_frame.from_jdbc_conf(
    frame = resolvechoice2,
    catalog_connection = "controlshift_production_data_sync",
    connection_options = {"preactions": "truncate table controlshiftdb.signatures;",
                          "dbtable": "controlshiftdb.signatures",
                          "database": "dev"},
